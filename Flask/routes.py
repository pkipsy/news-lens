...
from sandbox import InputModel, OutputModel, News, Wiki
import os
...
class AddressForm(FlaskForm):
    address = StringField('Please enter a news link:', [InputRequired()])
...
def results():
    ...
    title=session.get('title'), source=session.get('source'), image=session.get('image'),
